...
export default function ChangePassword() {
  ...
  return (
    <div className="mt-16 flex flex-col items-center h-screen">
      <h1 className="text-3xl mx-auto mt-2 font-sans font-medium">
        Change Password
      </h1>
      <form
      ...
      >
        {/* Current Password */}
        <label className="mt-6 block text-base text-gray-700 w-2/6 text-left">
          Current password
        </label>
          ...
          >
            {showCurrentPassword ? (
              ...
              >
                {" "}
                <path
                  d="M22.2991 12.1613C22.2991 12.1613 19.2991 18.1613 12.2991 18.1613C5.29907 18.1613 2.29907 12.1613 2.29907 12.1613C2.29907 12.1613 5.29907 6.16125 12.2991 6.16125C19.2991 6.16125 22.2991 12.1613 22.2991 12.1613Z"
                  stroke="black"
                  strokeLinecap="round"
                />{" "}
                <circle
        ...
        {errors.currentPassword && (
          <p className="text-xs text-red-500 w-2/6">{errors.currentPassword}</p>
        )}

        {/* New Password */}
        <label className="mt-4 block text-base text-gray-700 w-2/6 text-left">
          New password
        </label>
        <div className="relative w-2/6">
          <input
        ...
        {errors.newPassword && (
          <p className="text-xs text-red-500 w-2/6">{errors.newPassword}</p>
        )}
        ...
        {errors.confirmPassword && (
          <p className="text-xs text-red-500 w-2/6">{errors.confirmPassword}</p>
        )}

        {/* Submit Button */}
        <button
          type="submit"
          className="mt-6 w-2/6 p-3 text-white bg-indigo-400 rounded-xl hover:bg-indigo-500"
        >
          Save Changes
        </button>

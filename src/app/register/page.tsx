  ...
  return (
    <>
      <div className="flex h-screen customGray font-sans justify-center">
        ...
        ></div>
        <div className='bg-white relative z-10 shadow-4xl rounded-3xl overflow-hidden  my-auto'
          style={{ width: '1100px', height: '1300px' }}>
          <div className="mt-4 flex flex-col items-center justify-center">
            <h1 className="text-7xl mx-auto mt-24 font-sans font-medium">Sign Up</h1>
            <form onSubmit={handleSubmit} className="space-y-6 w-full lg:w-3/4 mx-auto mt-12">
              <div>
                ...
                <input
                  ...
                  className="mt-2 p-5 w-full text-3xl border border-slate-400 rounded-2xl  focus:outline-customDarkBlue"
                />
                {errors.email && <p className="eMessage">{errors.email}</p>}
              </div>

              <div>
                <label className="block text-3xl text-gray-700">Username</label>
                <input
                  type="text"
              ...
              <div className="flex space-x-8">
                <div className="w-1/2">
                  <label className="block text-3xl text-gray-700">First name</label>
                  <input
                    type="text"
                ...
                <div className="w-1/2">
                  <label className="block text-3xl text-gray-700">Surname</label>
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="relative w-full">
                  <input
                    ...
                    className="mt-2 p-5 w-full text-3xl border border-slate-400 rounded-2xl focus:outline-customDarkBlue pr-12"
                  />
                  <button
                    type="button"
                    onClick={togglePassword}
                    className="absolute inset-y-0 right-3 top-5 flex items-center text-xl leading-5 focus:outline-none"
                  >
                    {showPassword ? (  
                      <svg  width="55" height="50" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M22.2991 12.1613C22.2991 12.1613 19.2991 18.1613 12.2991 18.1613C5.29907 18.1613 2.29907 12.1613 2.29907 12.1613C2.29907 12.1613 5.29907 6.16125 12.2991 6.16125C19.2991 6.16125 22.2991 12.1613 22.2991 12.1613Z" stroke="black" stroke-linecap="round"/> <circle cx="12.2991" cy="12.1613" r="3" stroke="black" stroke-linecap="round"/> </svg>                      ) : (
              ...
              <div>
                <label className="block text-3xl text-gray-700">Confirm Password</label>
                <div className="relative w-full">
                  <input
              ...
              <div>
                <button type="submit" className="w-full bg-customDarkBlue text-3xl text-white p-5 rounded-lg hover:bg-sky-950 focus:outline-none focus:bg-sky-950 transition-colors duration-300 mt-3">Sign Up</button>
              </div>
            </form>
